		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p><strong><?php _e('Important Links:', 'mh-magazine-lite'); ?></strong>
					...
					<a href="https://www.facebook.com/MHthemes" target="_blank"><?php _e('Facebook', 'mh-magazine-lite'); ?></a>
					<a href="https://twitter.com/MHthemes" target="_blank"><?php _e('Twitter', 'mh-magazine-lite'); ?></a>
					<a href="https://www.youtube.com/user/MHthemesEN" target="_blank"><?php _e('YouTube', 'mh-magazine-lite'); ?></a>
				</p>
			</div>
			<hr>
