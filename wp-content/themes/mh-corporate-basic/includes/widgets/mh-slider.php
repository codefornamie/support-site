...
class mh_slider_hp_widget extends WP_Widget {
    function mh_slider_hp_widget() {
        $widget_ops = array('classname' => 'mh_slider_hp', 'description' => __('Slider widget for use on homepage template.', 'mh-corporate-basic'));
        $this->WP_Widget('mh_slider_hp', __('MH Slider lite (Homepage)', 'mh-corporate-basic'), $widget_ops);
    }
				...
				<article class="slide-wrap">
					...
					<div class="slide-caption">
						<div class="slide-data">
							...
							<div class="slide-excerpt"><?php mh_excerpt(); ?></div>
						</div>
					</div>
				</article>
				</li><?php
