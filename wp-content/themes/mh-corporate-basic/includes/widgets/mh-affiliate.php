...
class mh_affiliate_widget extends WP_Widget {
    function mh_affiliate_widget() {
        $widget_ops = array('classname' => 'mh_affiliate', 'description' => __('MH Affiliate Widget to earn money by promoting WordPress themes by MH Themes.', 'mh-corporate-basic'));
        $this->WP_Widget('mh_affiliate', __('MH Affiliate Widget', 'mh-corporate-basic'), $widget_ops);
    }
    ...
    function form($instance) {
        ...
        <p><?php echo __('With this widget you can earn money by promoting WordPress themes by MH Themes. If you do not have a Creative Market Username yet, please visit our:', 'mh-corporate-basic') . ' <a href="http://www.mhthemes.com/affiliates/" target="_blank">' . __('infopage for affiliates', 'mh-corporate-basic'). '</a>'; ?>.</p> <?php
    }
}
