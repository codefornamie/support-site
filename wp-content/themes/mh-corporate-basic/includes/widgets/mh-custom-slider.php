...
class mh_custom_slider_widget extends WP_Widget {
    function mh_custom_slider_widget() {
        $widget_ops = array('classname' => 'mh_custom_slider', 'description' => __('Custom Slider Widget to display custom content for use on homepage template.', 'mh-corporate-basic'));
        $this->WP_Widget('mh_custom_slider', __('MH Custom Slider lite (Homepage)', 'mh-corporate-basic'), $widget_ops);
    }
