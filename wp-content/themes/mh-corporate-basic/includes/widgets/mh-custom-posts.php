...
class mh_custom_posts_widget extends WP_Widget {
    function mh_custom_posts_widget() {
        $widget_ops = array('classname' => 'mh_custom_posts', 'description' => __('Custom Posts Widget to display posts based on categories.', 'mh-corporate-basic'));
        $this->WP_Widget('mh_custom_posts', __('MH Custom Posts lite', 'mh-corporate-basic'), $widget_ops);
    }
    ...
    function form($instance) {
        $defaults = array('title' => '', 'category' => '', 'postcount' => '5', 'offset' => '0', 'sticky' => 0);
