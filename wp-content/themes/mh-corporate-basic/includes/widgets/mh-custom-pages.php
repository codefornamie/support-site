...
class mh_custom_pages_widget extends WP_Widget {
    function mh_custom_pages_widget() {
        $widget_ops = array('classname' => 'mh_custom_pages', 'description' => __('Custom Pages Widget to display pages based on page IDs.', 'mh-corporate-basic'));
        $this->WP_Widget('mh_custom_pages', __('MH Custom Pages lite', 'mh-corporate-basic'), $widget_ops);
    }
