...
if (!function_exists('mh_scripts')) {
	function mh_scripts() {
		wp_enqueue_style('mh-google-fonts', "//fonts.googleapis.com/css?family=Open+Sans:300,400,400italic,600,700", array(), null);
		wp_enqueue_style('mh-style', get_stylesheet_uri(), false, '1.1.3');
...
if (!function_exists('mh_widgets_init')) {
	function mh_widgets_init() {
		register_sidebar(array('name' => __('Sidebar', 'mh-corporate-basic'), 'id' => 'sidebar', 'description' => __('Widget area (sidebar left/right) on single posts, pages and archives', 'mh-corporate-basic'), 'before_widget' => '<div class="sb-widget">', 'after_widget' => '</div>', 'before_title' => '<h4 class="widget-title">', 'after_title' => '</h4>'));
		register_sidebar(array('name' => sprintf(_x('Home %d', 'widget area name', 'mh-corporate-basic'), 1), 'id' => 'home-1', 'description' => __('Widget area on homepage', 'mh-corporate-basic'), 'before_widget' => '<div class="sb-widget home-1 home-wide">', 'after_widget' => '</div>', 'before_title' => '<h4 class="widget-title">', 'after_title' => '</h4>'));
		register_sidebar(array('name' => sprintf(_x('Home %d', 'widget area name', 'mh-corporate-basic'), 2), 'id' => 'home-2', 'description' => __('Widget area on homepage', 'mh-corporate-basic'), 'before_widget' => '<div class="sb-widget home-2">', 'after_widget' => '</div>', 'before_title' => '<h4 class="widget-title">', 'after_title' => '</h4>'));
		register_sidebar(array('name' => sprintf(_x('Home %d', 'widget area name', 'mh-corporate-basic'), 3), 'id' => 'home-3', 'description' => __('Widget area on homepage', 'mh-corporate-basic'), 'before_widget' => '<div class="sb-widget home-3">', 'after_widget' => '</div>', 'before_title' => '<h4 class="widget-title">', 'after_title' => '</h4>'));
		register_sidebar(array('name' => sprintf(_x('Home %d', 'widget area name', 'mh-corporate-basic'), 4), 'id' => 'home-4', 'description' => __('Widget area on homepage', 'mh-corporate-basic'), 'before_widget' => '<div class="sb-widget home-4">', 'after_widget' => '</div>', 'before_title' => '<h4 class="widget-title">', 'after_title' => '</h4>'));
		register_sidebar(array('name' => sprintf(_x('Footer %d', 'widget area name', 'mh-corporate-basic'), 1), 'id' => 'footer-1', 'description' => __('Widget area in footer', 'mh-corporate-basic'), 'before_widget' => '<div class="footer-widget footer-1">', 'after_widget' => '</div>', 'before_title' => '<h6 class="footer-widget-title">', 'after_title' => '</h6>'));
		register_sidebar(array('name' => sprintf(_x('Footer %d', 'widget area name', 'mh-corporate-basic'), 2), 'id' => 'footer-2', 'description' => __('Widget area in footer', 'mh-corporate-basic'), 'before_widget' => '<div class="footer-widget footer-2">', 'after_widget' => '</div>', 'before_title' => '<h6 class="footer-widget-title">', 'after_title' => '</h6>'));
		register_sidebar(array('name' => sprintf(_x('Footer %d', 'widget area name', 'mh-corporate-basic'), 3), 'id' => 'footer-3', 'description' => __('Widget area in footer', 'mh-corporate-basic'), 'before_widget' => '<div class="footer-widget footer-3">', 'after_widget' => '</div>', 'before_title' => '<h6 class="footer-widget-title">', 'after_title' => '</h6>'));
		register_sidebar(array('name' => sprintf(_x('Footer %d', 'widget area name', 'mh-corporate-basic'), 4), 'id' => 'footer-4', 'description' => __('Widget area in footer', 'mh-corporate-basic'), 'before_widget' => '<div class="footer-widget footer-4">', 'after_widget' => '</div>', 'before_title' => '<h6 class="footer-widget-title">', 'after_title' => '</h6>'));
	}
}
...
if (!function_exists('mh_wp_title')) {
	function mh_wp_title($title, $sep) {
		...
		if ($paged >= 2 || $page >= 2)
			$title = "$title $sep " . sprintf(__('Page %s', 'mh-corporate-basic'), max($paged, $page));
		return $title;
	}
}
