		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p><strong><?php _e('Important Links:', 'mh-corporate-basic'); ?></strong>
					<a href="http://www.mhthemes.com/themes/mh/corporate-lite/" target="_blank"><?php _e('Theme Info Page', 'mh-corporate-basic'); ?></a>
					<a href="http://www.mhthemes.com/support/" target="_blank"><?php _e('Support Center', 'mh-corporate-basic'); ?></a>
					<a href="http://wordpress.org/support/view/theme-reviews/mh-corporate-basic?filter=5" target="_blank"><?php _e('Rate this theme', 'mh-corporate-basic'); ?></a>
					<a href="https://www.facebook.com/MHthemes" target="_blank"><?php _e('Facebook', 'mh-corporate-basic'); ?></a>
					<a href="https://twitter.com/MHthemes" target="_blank"><?php _e('Twitter', 'mh-corporate-basic'); ?></a>
					<a href="https://www.youtube.com/user/MHthemesEN" target="_blank"><?php _e('YouTube', 'mh-corporate-basic'); ?></a>
				</p>
			</div>
			<hr>
				...
				<div class="row clearfix">
					<div class="col-1-2">
						<div class="section">
							...
							<p>
								<a href="http://www.mhthemes.com/themes/mh/corporate-lite/" target="_blank" class="button button-secondary"><?php _e('Visit Documentation', 'mh-corporate-basic'); ?></a>
							</p>
						</div>
						<div class="section">
						...
						<div class="section">
							...
							<p>
								<a href="http://www.mhthemes.com/themes/mh/corporate/" target="_blank" class="button button-secondary"><?php _e('Learn more about the Premium Version', 'mh-corporate-basic'); ?></a>
							</p>
						</div>
					</div>
					<div class="col-1-2">
